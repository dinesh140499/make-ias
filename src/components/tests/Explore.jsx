...
import { setFilter, setTab } from '../../features/testsSlice'
...
const Explore = () => {
    const { filter, tab } = useSelector(state => state.testsSlice)
        ...
        <div className='mt-10 mb-7'>
            <div className="container95">
                <div className="lg:flex items-center justify-between ">
                    ...
                    <div className="flex items-center gap-3 border border-[#DB251B] radius7 py-2 px-1 w-full lg:w-auto mt-3">
