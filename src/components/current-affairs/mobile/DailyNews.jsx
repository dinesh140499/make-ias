                ...
                <div className="flex lg:flex-row mt-5 gap-5 flex-wrap">
                    ...
                    <div className="right flex-1 pr-5 radius7 shadow bg-[#dedede1e] ">
                        <div className="w-full px-3 py-3">
                            <div className="flex py-1 rounded-t-[10px] w-full justify-between items-center">
                            ...
                            <div className="">
                                ...
                                <article className='theme-para-grey text-md'>
                                ...
                                <div className='flex items-center justify-center border-t mt-5 h-[200px]'>
