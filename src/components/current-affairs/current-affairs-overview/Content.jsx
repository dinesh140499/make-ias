    ...
    return (
        <>
            <div className='lg:w-[75%]'>
                ...
                <h3 className='capitalize font22 mb-5 mt-5'>Basalt Mining Begins at Deocha-Pachami</h3>
                ...
                <div className="text-right mt-5 w-full" onClick={sharePage}>
                <IoShareSocial className='w-full theme-text-red cursor-pointer font20' />
            </div>
            </div>
